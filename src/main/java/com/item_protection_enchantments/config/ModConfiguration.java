...
public class ModConfiguration {
    ...
    public static final ForgeConfigSpec.BooleanValue ANVIL_BUG_FIX;

    public static final ForgeConfigSpec.EnumValue<ItemProtectionEnchantment.EnchantmentTypes> FIRE_PROTECTION_ENCHANTABLE_ITEMS;
    ...
    public static final ForgeConfigSpec.EnumValue<ItemProtectionEnchantment.EnchantmentTypes> CACTUS_PROTECTION_ENCHANTABLE_ITEMS;
    ...
    public static final ForgeConfigSpec.EnumValue<ItemProtectionEnchantment.EnchantmentTypes> BLAST_PROTECTION_ENCHANTABLE_ITEMS;
    ...
    public static final ForgeConfigSpec.EnumValue<ItemProtectionEnchantment.EnchantmentTypes> VOID_PROTECTION_ENCHANTABLE_ITEMS;
    ...
    public static final ForgeConfigSpec.EnumValue<ItemProtectionEnchantment.EnchantmentTypes> EXPIRE_PROTECTION_ENCHANTABLE_ITEMS;
    ...
    public static final ForgeConfigSpec.EnumValue<ItemProtectionEnchantment.EnchantmentTypes> INVENTORY_HOLDING_ENCHANTABLE_ITEMS;
    ...
    static {
        ...
        ANVIL_BUG_FIX = COMMON_CONFIG_BUILDER.comment("Whether to fix the bug where anvils falling on items would cause the items to disappear")
                .define("anvilBugFix", true);
