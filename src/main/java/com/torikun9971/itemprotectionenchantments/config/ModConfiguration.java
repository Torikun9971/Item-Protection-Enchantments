...
import com.torikun9971.itemprotectionenchantments.enchantments.BaseProtectionEnchantment.EnchantmentTypes;
...
public class ModConfiguration implements ConfigData {
    ...
    public interface IBaseProtectionConfig {
        EnchantmentTypes getEnchantableItems();
    ...
    public static class FireProtectionConfig implements IBaseProtectionConfig {
        @Tooltip
        @EnumHandler
        public EnchantmentTypes enchantableItems = BaseProtectionEnchantment.CATEGORY;
        ...
        @Override
        public EnchantmentTypes getEnchantableItems() {
